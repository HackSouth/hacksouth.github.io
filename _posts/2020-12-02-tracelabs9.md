...
A few weeks ago, a few of us took part in the TraceLabs missing persons CTF. It was our 4th shot as a **Hack South** Team, but this time we scored a podium finish and just missed out on 2nd place. This is the story of how we did it, with no case specifics.<!--more-->

[![The Team](/assets/images/Tracelabs/Twitter_win_post.png)]{: .align-center}

### What is this?
*Crowdsourced OSINT*  
[TraceLabs](https://www.tracelabs.org/about/what-we-do) leverages crowdsourced open source intelligence through both Trace Labs OSINT Search Party CTFs and Ongoing Operations with their global community. Their highly skilled intelligence analysts triage data collected to produce actionable intelligence reports on each missing person. The reports give law enforcement agencies the ability to quickly see any new details required to reopen a cold case and/or take immediate action on a missing subject.
...
We typically start a TraceLabs CTF with the mindset to have fun and learn something. If our initial work is good, we do this to win, but that determination and result often stems from identifying and submitting high quality intelligence that can lead to finding a missing person or at least newer sources of intel for law enforcement to follow up with and either find the child/person or close a case do to passing.
...
Next piece is important. It is crucial you understand what you might find and the nature of it. You might find underage children committing crimes, might find things of a violent or sexual nature. It is important to keep this all at an arms reach.     

Lastly you need to understand what the result is. As with most forms of intelligence, you typically want to know what the result should look like. To get to that result you will typically gain as much intel about the subject, and once that is exhausted, you start looking at ancillary people and information. Siblings, family, parents, partners, work etc etc. You can go down one path, and that can lead to another, but go down too many asides you soon find yourself down a parth of irrelevance. The way I see it is if the intel adds value, I keep upping the degrees of separation between the subject and wherever I am, when I feel it is going nowhere I slowly step closer to the subject in degrees of separation till I am back on the subject and can then identify new avenues.     

### What now, and how do I do this? 
Now that you understand what needs to happen, now what?
...
*"You are Scooby Doo war dialling the internet, leave to solution of the case to the cops."*
...
Case 1 - We had a well-known case of a mother going missing in the UK, last seen at an Off-License on CCTV
Case 2 - We had a girl in the USA from Missouri who came from a bad home and had a history of going missing
Case 3 - We had a man living in Canada who was believed to have moved to the UAE (1000+ Days)
Case 4 - We had a case of an Arab woman in Canada who had not returned to the UAE
